namespace Sales.Backend.Helpers
{
    ...
    public class UsersHelper : IDisposable
    {
        ...
        public static void CheckSuperUser()
        {
            ...
            if (userASP == null)
            {
                CreateUserASP(email, RolesHelper.ADMIN, password);
                return;
            }

            var users = db.Users
            .Where(u => u.UserName.ToLower().Equals(email))
            .FirstOrDefault();
            ...
            if (users == null)
            {
                users = new User
                {
                    Address = "Scotland the Brave & Flower of Scotland & Japan Tokio",
                    PostalCode = "100-1103",
                    FirstName = "Draco Balder",
                    LastName = "Hunter Master",
                    Telephone = "81+ 80-1234-5678",
                    Cellphone = "81+ 80-1234-0000",
                    ImagePath = string.Format("~/Content/Users/CyborgSamurai.jpg"),
                    UserName = email,
                    NickName = "Gouken",
                    ImageMimeType = "image/jpg",
                    UserTypeId = DBHelper.GetUserTypes("Local", db)
                };
